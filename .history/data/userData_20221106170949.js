...
UserData.belongsTo(Match, { foreignKey: 'matchId' });
UserData.belongsTo(BeforeMatch, { foreignKey: 'beforeMatchId' });
UserData.belongsTo(User, { foreignKey: 'user1Id' });
UserData.belongsTo(User, { foreignKey: 'user2Id' });
